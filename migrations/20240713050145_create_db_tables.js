...
export const up = function (knex) {
  return knex.schema
    ...
    .then(() =>
      knex.raw('ALTER TABLE users CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci')
    )
    .then(() => {
      return knex.schema.createTable('exchange_items', function (table) {
        ...
        table.integer('reserved_by').unsigned().references('id').inTable('users').onDelete('SET NULL');
